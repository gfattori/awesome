-- Perceptive, a weather notification module for Awesome WM 3.5+.
--
-- Author: Ilia Glazkov
-- Forker: Luke Bonham
...
--local localizations_path = project_path .. 'localizations/localization_stub'
...
function execute(url, callback)
    ...
    local execute_timer = timer({ timeout = 30 })
